      ...
      <>
        ...
        <div className="container-fluid text-center item-center">
          <div class="row row-cols row-cols-md ">
            ...
            <div class="col-4">
              <div class="card">
                <img src={circ.Team1Image} class="card-img-top"  alt="..." />
                <div class="card-body">
            ...
            <div class="card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTq4niYY9AxyCmjr2L9_UDNl4hFsP9hwx4NaA&usqp=CAU" class="card-img-top" alt="..." />
              </div>

    ...
    <>
      ...
      <div className="container-fluid m-4">
        <div className="row m-3">
          <div class="col-5 m-3 card border-primary" >
            <div class="row ">
              <div class="col-md  p-2">
                <img src={data.Team1Image} class="img-fluid rounded py-1  ms-3 h-100" alt="..." />
              </div>
              <div class="col">
                <div class="card-body">
          ...
          <div class="col-5 m-3 ms-5 card border-primary" >
            <div class="row ">
              <div class="col p-2">
                <img src={data.Team2Image} class="img-fluid rounded py-1  ms-3 h-100" alt="..." />
              </div>
              <div class="col-md">
                <div class="card-body">
